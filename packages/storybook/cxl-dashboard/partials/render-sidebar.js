...
const RenderSidebarMenuItem = (menuItem) => html`
  ${menuItem.menu.length > 0
    ...
    : html` <a href="${menuItem.url}" theme="cxl-dashboard-sidebar">${menuItem.title}</a> `}
`;

const RenderSidebar = () =>
  html`
    <cxl-vaadin-accordion id="dashboard-sidebar-menu" theme="cxl-dashboard-sidebar">
